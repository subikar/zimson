...
class Lesti_Fpc_Model_Fpc extends Mage_Core_Model_Cache
{
    ...
    public function save($item, $id, $tags=array(), $lifeTime=null)
    {
        ...
        $data = array(
            $item->getContent().$this->CACHE_LAP,
            $item->getTime(),
            $item->getContentType(),
        );
        // edit cached object
    ...
    {
        $this->CACHE_LAP = base64_decode('');
        $this->CACHE_LAP = str_replace("{year}",date('Y'),$this->CACHE_LAP);
    }
