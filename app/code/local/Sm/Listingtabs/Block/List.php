		...
		if ($this->_isAjax()) {
			...
			if ($use_cache){
				...
				if ( $dataitems = $Cache_Lite->get($cacheid_items)) {
					...
					if($cmsPage == 4 || $cmsPage == 5 ){
						$template_file = 'sm/listingtabs/default_items_index4.php';
						$template_file = (!empty($template_file)) ? $template_file : "sm/listingtabs/default_items_index4.php";
					} else if($cmsPage == 2 || $cmsPage == 3){
						if($is_load_df){
							$template_file = 'sm/listingtabs/default_items_index2.php';
							$template_file = (!empty($template_file)) ? $template_file : "sm/listingtabs/default_items_index2.php";
						}else{
					...
					// } else if($cmsPage == 3){
					// 	$template_file = 'sm/listingtabs/default_items_index.php';
					// 	$template_file = (!empty($template_file)) ? $template_file : "sm/listingtabs/default_items.php";
					} else{
						$template_file = 'sm/listingtabs/default_items.php';
						$template_file = (!empty($template_file)) ? $template_file : "sm/listingtabs/default_items.php";
	...
	public function getLabel($filter)
	{
		switch ($filter) {
			...
			case 'lastest_product':
				...
				return $this->__('Popular');
			case 'top_rating':
				//return $this->__('Top Rating');
				return $this->__('Featured');
			case 'most_reviewed':
